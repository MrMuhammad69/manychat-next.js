...
const ActiveTrigger = ({keywords,type}: Props) => {
  return (
    <div className='bg-background-80 p-3 rounded-xl w-full'>
        ...
        <p className='text-md font-light text-text-secondary'>{type === 'COMMENT'? 'If the user comments on a video/picture/carousel that is setup to listen for a keyword, this automation will fire  ': 'If the user sends you a message that contains that specific keyword, this automation will fire'}
        </p>
